...
\advisor{\\\vspace{0.25cm}Dra. Aymée Marrero Severo\\\vspace{0.2cm}Nombre del segundo tutor}
\degree{Licenciado en (Matemática o Ciencia de la Computación)}
\faculty{Facultad de Matemática y Computación}
\date{La Habana, enero 2025.\\\vspace{0.25cm}\href{https://github.com/username/repo}{github.com/username/repo}}
...
\include{MainMatter/resultsValidation}

...
\label{sec:17}
    ...
    Ventajas: Los bosques aleatorios suelen ofrecer resultados más precisos que otros métodos debido a su capacidad para combinar múltiples predicciones. Al utilizar 

...
\label{sec:15}
    ...
    \subsection*{Arquitectura de Agentes Cooperativos}
        ...
        Antes de referirnos a los detalles de la arquitectura es necesario precisar que la estrategia propuesta se basa en una red de agentes donde cada uno tiene una funcionalidad específica y se entrena para mejorar sus resultados. Notar que este entrenamiento es supervisado. \\
        ...
        que recibe la tupla $(P,X)$ y devuelve un valor $Y$ que es donde se espera que esté la respuesta. Estos agentes se determinan al inicio del entrenamiento.
